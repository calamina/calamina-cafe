...
<p class="info"><sup>1</sup> Un [GIF](https://en.wikipedia.org/wiki/GIF) est une image souvent animée, elle est jouée et se répète en boucle automatiquement sur le web contrairement à la plupart des vidéos.</p>
