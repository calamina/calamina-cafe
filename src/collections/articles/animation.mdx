...
Pendant le processus, deux aspects sont très *intriguants*.
...
J'imagine bien que tout est très certainement lié à *l'argent* et au *temps*. Et puis je réalise que je n'ai qu'une très vague idée de la manière dont est conçu un dessin animé.
...
Ou c'est quoi le cinéma, c'est quoi une vidéo, et pourquoi on fait comme ça. (en bref!)

#todo

Parcours pour décrire l'animation 2D : 
